...
const config: Config = {
  ...
  themeConfig: {
    ...
    metadata: [
      ...
      {name: 'twitter:title', content: 'SolidOS Docs - Developer Documentation for Solid'},
      {name: 'twitter:description', content: 'Build data browsers and panes for the Solid ecosystem'},
      {property: 'og:type', content: 'website'},
      {property: 'og:title', content: 'SolidOS Docs - Developer Documentation for Solid'},
    ...
    announcementBar: {
      id: 'contribute',
      content: 'Community-maintained docs for SolidOS. Help improve them - <a href="https://github.com/solid-docs/docs">Contribute on GitHub</a>',
      ...
      items: [
        ...
        },
        {
          ...
          items: [
            {
              label: 'User Guide',
              href: 'https://solidos.org/userguide/',
            },
            {
              type: 'html',
      ...
      links: [
        {
          title: 'Learn',
          items: [
            {label: 'User Guide', href: 'https://solidos.org/userguide/'},
